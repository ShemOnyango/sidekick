...
class EmailService {
  ...
  async sendTripReportEmail(reportData, recipients) {
    try {
      ...
      // Prepare email
      const mailOptions = {
        from: `"Herzog Rail Authority" <${process.env.SMTP_USER}>`,
        to: recipients,
  ...
  getDefaultTripReportTemplate() {
    return handlebars.compile(`
      ...
      <body>
        ...
        <div class="footer">
          <p>This report was automatically generated by Herzog Rail Authority System.</p>
  ...
  async sendSystemNotification(recipients, subject, message, options = {}) {
    try {
      ...
      const mailOptions = {
        from: `"Herzog Rail Authority System" <${process.env.SMTP_USER}>`,
  ...
  formatPlainTextAsHTML(text) {
    return `
      ...
      <body>
        ...
        <div class="footer">
          <p>This is an automated message from Herzog Rail Authority System.</p>
        </div>
      </body>
      </html>
    `;
    ...
    try {
      ...
      const htmlContent = `
        ...
        <body>
          ...
          <div class="footer">
            <p>This alert was automatically generated by Herzog Rail Authority System.</p>
    ...
    try {
      ...
      const htmlContent = `
        ...
        <body>
          ...
          <div class="footer">
            <p>This is an automated daily summary from Herzog Rail Authority System.</p>
            <p>Generated: ${formatDateTime(new Date())}</p>
          </div>
        </body>
        </html>
